...
select * from vendor_market_price_zg where interval_min = 30 order by time desc



select DATE_TRUNC('hour', vmpc."time" ) as d, count(1) from vendor_market_price_cadusd vmpc where interval_min = 1 group by DATE_TRUNC('hour', vmpc."time" ) order by d desc
select DATE_TRUNC('hour', vmpc."time" ) as d, count(1) from vendor_market_price_cadusd vmpc where interval_min = 1 group by DATE_TRUNC('hour', vmpc."time" ) having count(1) < 60 order by d desc
select DATE_TRUNC('hour', vmpx."time" ) as d, count(1) from vendor_market_price_zg vmpx where interval_min = 30 group by DATE_TRUNC('hour', vmpx."time" ) order by d desc

select DATE_TRUNC('hour', vmpc."time" ) as d, count(1) from vendor_market_price_cadusd vmpc where interval_min = 1 group by DATE_TRUNC('hour', vmpc."time" ) and count(1) != 60 order by d desc

select * from vendor_market_price_zg  where interval_min = 30 order by time desc
select * from vendor_market_price where code = 'ZG' order by time desc



select DATE_TRUNC('hour', vmpx."time" ) as d, count(1) from vendor_market_price_tmp vmpx where code = 'ZG' and interval_min = 5 group by DATE_TRUNC('hour', vmpx."time" ) having count(1) < 60 order by d desc

select DATE_TRUNC('hour', vmpx."time" ) as d, count(1) from vendor_market_price_tmp vmpx where code = 'CADUSD' and interval_min = 1 group by DATE_TRUNC('hour', vmpx."time" ) having count(1) < 60 order by d desc





SELECT  split_part(table_name, '_', 3)
FROM information_schema.tables
WHERE table_schema = 'public'
and table_name like 'market_price%' and table_name not in ('market_price', 'market_price_asc_view', 'market_price_desc_view') 
...
SELECT distinct 'CREATE TABLE public.market_price_' || split_part(table_name, '_', 3) || '_every_five_minute (	id bigserial NOT NULL, 	high numeric(20, 10) NULL, 	low numeric(20, 10) NULL, 	"close" numeric(20, 10) NULL, 	"open" numeric(20, 10) NULL,	"time" timestamptz NULL, 	CONSTRAINT market_price_'|| split_part(table_name, '_', 3) ||'_five_minute_pkey PRIMARY KEY (id)); CREATE INDEX market_price_'|| split_part(table_name, '_', 3) ||'_five_minute_1 ON public.market_price_'|| split_part(table_name, '_', 3) ||'_five_minute USING btree ("time");'
FROM information_schema.tables
WHERE table_schema = 'public'
and table_name like 'market_price%' and table_name not in ('market_price', 'market_price_asc_view', 'market_price_desc_view') 
...
select * from public.market_price_de30_every_fifteen_minute order by time asc

CREATE TABLE public.market_price_audusd_every_fifteen_minute (	id bigserial NOT NULL, 	high numeric(20, 10) NULL, 	low numeric(20, 10) NULL, 	"close" numeric(20, 10) NULL, 	"open" numeric(20, 10) NULL,	"time" timestamptz NULL, 	CONSTRAINT market_price_audusd_fifteen_minute_pkey PRIMARY KEY (id)); CREATE INDEX market_price_audusd_fifteen_minute_1 ON public.market_price_audusd_every_fifteen_minute USING btree ("time");
CREATE TABLE public.market_price_axjo_every_fifteen_minute (	id bigserial NOT NULL, 	high numeric(20, 10) NULL, 	low numeric(20, 10) NULL, 	"close" numeric(20, 10) NULL, 	"open" numeric(20, 10) NULL,	"time" timestamptz NULL, 	CONSTRAINT market_price_axjo_fifteen_minute_pkey PRIMARY KEY (id)); CREATE INDEX market_price_axjo_fifteen_minute_1 ON public.market_price_axjo_every_fifteen_minute USING btree ("time");
CREATE TABLE public.market_price_btc_every_fifteen_minute (	id bigserial NOT NULL, 	high numeric(20, 10) NULL, 	low numeric(20, 10) NULL, 	"close" numeric(20, 10) NULL, 	"open" numeric(20, 10) NULL,	"time" timestamptz NULL, 	CONSTRAINT market_price_btc_fifteen_minute_pkey PRIMARY KEY (id)); CREATE INDEX market_price_btc_fifteen_minute_1 ON public.market_price_btc_every_fifteen_minute USING btree ("time");
CREATE TABLE public.market_price_cadusd_every_fifteen_minute (	id bigserial NOT NULL, 	high numeric(20, 10) NULL, 	low numeric(20, 10) NULL, 	"close" numeric(20, 10) NULL, 	"open" numeric(20, 10) NULL,	"time" timestamptz NULL, 	CONSTRAINT market_price_cadusd_fifteen_minute_pkey PRIMARY KEY (id)); CREATE INDEX market_price_cadusd_fifteen_minute_1 ON public.market_price_cadusd_every_fifteen_minute USING btree ("time");
CREATE TABLE public.market_price_cc_every_fifteen_minute (	id bigserial NOT NULL, 	high numeric(20, 10) NULL, 	low numeric(20, 10) NULL, 	"close" numeric(20, 10) NULL, 	"open" numeric(20, 10) NULL,	"time" timestamptz NULL, 	CONSTRAINT market_price_cc_fifteen_minute_pkey PRIMARY KEY (id)); CREATE INDEX market_price_cc_fifteen_minute_1 ON public.market_price_cc_every_fifteen_minute USING btree ("time");
CREATE TABLE public.market_price_chfusd_every_fifteen_minute (	id bigserial NOT NULL, 	high numeric(20, 10) NULL, 	low numeric(20, 10) NULL, 	"close" numeric(20, 10) NULL, 	"open" numeric(20, 10) NULL,	"time" timestamptz NULL, 	CONSTRAINT market_price_chfusd_fifteen_minute_pkey PRIMARY KEY (id)); CREATE INDEX market_price_chfusd_fifteen_minute_1 ON public.market_price_chfusd_every_fifteen_minute USING btree ("time");
CREATE TABLE public.market_price_ct_every_fifteen_minute (	id bigserial NOT NULL, 	high numeric(20, 10) NULL, 	low numeric(20, 10) NULL, 	"close" numeric(20, 10) NULL, 	"open" numeric(20, 10) NULL,	"time" timestamptz NULL, 	CONSTRAINT market_price_ct_fifteen_minute_pkey PRIMARY KEY (id)); CREATE INDEX market_price_ct_fifteen_minute_1 ON public.market_price_ct_every_fifteen_minute USING btree ("time");
CREATE TABLE public.market_price_de30_every_fifteen_minute (	id bigserial NOT NULL, 	high numeric(20, 10) NULL, 	low numeric(20, 10) NULL, 	"close" numeric(20, 10) NULL, 	"open" numeric(20, 10) NULL,	"time" timestamptz NULL, 	CONSTRAINT market_price_de30_fifteen_minute_pkey PRIMARY KEY (id)); CREATE INDEX market_price_de30_fifteen_minute_1 ON public.market_price_de30_every_fifteen_minute USING btree ("time");
CREATE TABLE public.market_price_dxy_every_fifteen_minute (	id bigserial NOT NULL, 	high numeric(20, 10) NULL, 	low numeric(20, 10) NULL, 	"close" numeric(20, 10) NULL, 	"open" numeric(20, 10) NULL,	"time" timestamptz NULL, 	CONSTRAINT market_price_dxy_fifteen_minute_pkey PRIMARY KEY (id)); CREATE INDEX market_price_dxy_fifteen_minute_1 ON public.market_price_dxy_every_fifteen_minute USING btree ("time");
CREATE TABLE public.market_price_eth_every_fifteen_minute (	id bigserial NOT NULL, 	high numeric(20, 10) NULL, 	low numeric(20, 10) NULL, 	"close" numeric(20, 10) NULL, 	"open" numeric(20, 10) NULL,	"time" timestamptz NULL, 	CONSTRAINT market_price_eth_fifteen_minute_pkey PRIMARY KEY (id)); CREATE INDEX market_price_eth_fifteen_minute_1 ON public.market_price_eth_every_fifteen_minute USING btree ("time");
CREATE TABLE public.market_price_eurusd_every_fifteen_minute (	id bigserial NOT NULL, 	high numeric(20, 10) NULL, 	low numeric(20, 10) NULL, 	"close" numeric(20, 10) NULL, 	"open" numeric(20, 10) NULL,	"time" timestamptz NULL, 	CONSTRAINT market_price_eurusd_fifteen_minute_pkey PRIMARY KEY (id)); CREATE INDEX market_price_eurusd_fifteen_minute_1 ON public.market_price_eurusd_every_fifteen_minute USING btree ("time");
CREATE TABLE public.market_price_fchi_every_fifteen_minute (	id bigserial NOT NULL, 	high numeric(20, 10) NULL, 	low numeric(20, 10) NULL, 	"close" numeric(20, 10) NULL, 	"open" numeric(20, 10) NULL,	"time" timestamptz NULL, 	CONSTRAINT market_price_fchi_fifteen_minute_pkey PRIMARY KEY (id)); CREATE INDEX market_price_fchi_fifteen_minute_1 ON public.market_price_fchi_every_fifteen_minute USING btree ("time");
CREATE TABLE public.market_price_gbpusd_every_fifteen_minute (	id bigserial NOT NULL, 	high numeric(20, 10) NULL, 	low numeric(20, 10) NULL, 	"close" numeric(20, 10) NULL, 	"open" numeric(20, 10) NULL,	"time" timestamptz NULL, 	CONSTRAINT market_price_gbpusd_fifteen_minute_pkey PRIMARY KEY (id)); CREATE INDEX market_price_gbpusd_fifteen_minute_1 ON public.market_price_gbpusd_every_fifteen_minute USING btree ("time");
CREATE TABLE public.market_price_hg_every_fifteen_minute (	id bigserial NOT NULL, 	high numeric(20, 10) NULL, 	low numeric(20, 10) NULL, 	"close" numeric(20, 10) NULL, 	"open" numeric(20, 10) NULL,	"time" timestamptz NULL, 	CONSTRAINT market_price_hg_fifteen_minute_pkey PRIMARY KEY (id)); CREATE INDEX market_price_hg_fifteen_minute_1 ON public.market_price_hg_every_fifteen_minute USING btree ("time");
CREATE TABLE public.market_price_hk50_every_fifteen_minute (	id bigserial NOT NULL, 	high numeric(20, 10) NULL, 	low numeric(20, 10) NULL, 	"close" numeric(20, 10) NULL, 	"open" numeric(20, 10) NULL,	"time" timestamptz NULL, 	CONSTRAINT market_price_hk50_fifteen_minute_pkey PRIMARY KEY (id)); CREATE INDEX market_price_hk50_fifteen_minute_1 ON public.market_price_hk50_every_fifteen_minute USING btree ("time");
CREATE TABLE public.market_price_hsce_every_fifteen_minute (	id bigserial NOT NULL, 	high numeric(20, 10) NULL, 	low numeric(20, 10) NULL, 	"close" numeric(20, 10) NULL, 	"open" numeric(20, 10) NULL,	"time" timestamptz NULL, 	CONSTRAINT market_price_hsce_fifteen_minute_pkey PRIMARY KEY (id)); CREATE INDEX market_price_hsce_fifteen_minute_1 ON public.market_price_hsce_every_fifteen_minute USING btree ("time");
CREATE TABLE public.market_price_ixic_every_fifteen_minute (	id bigserial NOT NULL, 	high numeric(20, 10) NULL, 	low numeric(20, 10) NULL, 	"close" numeric(20, 10) NULL, 	"open" numeric(20, 10) NULL,	"time" timestamptz NULL, 	CONSTRAINT market_price_ixic_fifteen_minute_pkey PRIMARY KEY (id)); CREATE INDEX market_price_ixic_fifteen_minute_1 ON public.market_price_ixic_every_fifteen_minute USING btree ("time");
CREATE TABLE public.market_price_jp225_every_fifteen_minute (	id bigserial NOT NULL, 	high numeric(20, 10) NULL, 	low numeric(20, 10) NULL, 	"close" numeric(20, 10) NULL, 	"open" numeric(20, 10) NULL,	"time" timestamptz NULL, 	CONSTRAINT market_price_jp225_fifteen_minute_pkey PRIMARY KEY (id)); CREATE INDEX market_price_jp225_fifteen_minute_1 ON public.market_price_jp225_every_fifteen_minute USING btree ("time");
CREATE TABLE public.market_price_jpyusd_every_fifteen_minute (	id bigserial NOT NULL, 	high numeric(20, 10) NULL, 	low numeric(20, 10) NULL, 	"close" numeric(20, 10) NULL, 	"open" numeric(20, 10) NULL,	"time" timestamptz NULL, 	CONSTRAINT market_price_jpyusd_fifteen_minute_pkey PRIMARY KEY (id)); CREATE INDEX market_price_jpyusd_fifteen_minute_1 ON public.market_price_jpyusd_every_fifteen_minute USING btree ("time");
CREATE TABLE public.market_price_kc_every_fifteen_minute (	id bigserial NOT NULL, 	high numeric(20, 10) NULL, 	low numeric(20, 10) NULL, 	"close" numeric(20, 10) NULL, 	"open" numeric(20, 10) NULL,	"time" timestamptz NULL, 	CONSTRAINT market_price_kc_fifteen_minute_pkey PRIMARY KEY (id)); CREATE INDEX market_price_kc_fifteen_minute_1 ON public.market_price_kc_every_fifteen_minute USING btree ("time");
CREATE TABLE public.market_price_ng_every_fifteen_minute (	id bigserial NOT NULL, 	high numeric(20, 10) NULL, 	low numeric(20, 10) NULL, 	"close" numeric(20, 10) NULL, 	"open" numeric(20, 10) NULL,	"time" timestamptz NULL, 	CONSTRAINT market_price_ng_fifteen_minute_pkey PRIMARY KEY (id)); CREATE INDEX market_price_ng_fifteen_minute_1 ON public.market_price_ng_every_fifteen_minute USING btree ("time");
CREATE TABLE public.market_price_nzdusd_every_fifteen_minute (	id bigserial NOT NULL, 	high numeric(20, 10) NULL, 	low numeric(20, 10) NULL, 	"close" numeric(20, 10) NULL, 	"open" numeric(20, 10) NULL,	"time" timestamptz NULL, 	CONSTRAINT market_price_nzdusd_fifteen_minute_pkey PRIMARY KEY (id)); CREATE INDEX market_price_nzdusd_fifteen_minute_1 ON public.market_price_nzdusd_every_fifteen_minute USING btree ("time");
CREATE TABLE public.market_price_oj_every_fifteen_minute (	id bigserial NOT NULL, 	high numeric(20, 10) NULL, 	low numeric(20, 10) NULL, 	"close" numeric(20, 10) NULL, 	"open" numeric(20, 10) NULL,	"time" timestamptz NULL, 	CONSTRAINT market_price_oj_fifteen_minute_pkey PRIMARY KEY (id)); CREATE INDEX market_price_oj_fifteen_minute_1 ON public.market_price_oj_every_fifteen_minute USING btree ("time");
CREATE TABLE public.market_price_pl_every_fifteen_minute (	id bigserial NOT NULL, 	high numeric(20, 10) NULL, 	low numeric(20, 10) NULL, 	"close" numeric(20, 10) NULL, 	"open" numeric(20, 10) NULL,	"time" timestamptz NULL, 	CONSTRAINT market_price_pl_fifteen_minute_pkey PRIMARY KEY (id)); CREATE INDEX market_price_pl_fifteen_minute_1 ON public.market_price_pl_every_fifteen_minute USING btree ("time");
CREATE TABLE public.market_price_sb_every_fifteen_minute (	id bigserial NOT NULL, 	high numeric(20, 10) NULL, 	low numeric(20, 10) NULL, 	"close" numeric(20, 10) NULL, 	"open" numeric(20, 10) NULL,	"time" timestamptz NULL, 	CONSTRAINT market_price_sb_fifteen_minute_pkey PRIMARY KEY (id)); CREATE INDEX market_price_sb_fifteen_minute_1 ON public.market_price_sb_every_fifteen_minute USING btree ("time");
CREATE TABLE public.market_price_t_every_fifteen_minute (	id bigserial NOT NULL, 	high numeric(20, 10) NULL, 	low numeric(20, 10) NULL, 	"close" numeric(20, 10) NULL, 	"open" numeric(20, 10) NULL,	"time" timestamptz NULL, 	CONSTRAINT market_price_t_fifteen_minute_pkey PRIMARY KEY (id)); CREATE INDEX market_price_t_fifteen_minute_1 ON public.market_price_t_every_fifteen_minute USING btree ("time");
CREATE TABLE public.market_price_tmp_every_fifteen_minute (	id bigserial NOT NULL, 	high numeric(20, 10) NULL, 	low numeric(20, 10) NULL, 	"close" numeric(20, 10) NULL, 	"open" numeric(20, 10) NULL,	"time" timestamptz NULL, 	CONSTRAINT market_price_tmp_fifteen_minute_pkey PRIMARY KEY (id)); CREATE INDEX market_price_tmp_fifteen_minute_1 ON public.market_price_tmp_every_fifteen_minute USING btree ("time");
CREATE TABLE public.market_price_uk100_every_fifteen_minute (	id bigserial NOT NULL, 	high numeric(20, 10) NULL, 	low numeric(20, 10) NULL, 	"close" numeric(20, 10) NULL, 	"open" numeric(20, 10) NULL,	"time" timestamptz NULL, 	CONSTRAINT market_price_uk100_fifteen_minute_pkey PRIMARY KEY (id)); CREATE INDEX market_price_uk100_fifteen_minute_1 ON public.market_price_uk100_every_fifteen_minute USING btree ("time");
CREATE TABLE public.market_price_us500_every_fifteen_minute (	id bigserial NOT NULL, 	high numeric(20, 10) NULL, 	low numeric(20, 10) NULL, 	"close" numeric(20, 10) NULL, 	"open" numeric(20, 10) NULL,	"time" timestamptz NULL, 	CONSTRAINT market_price_us500_fifteen_minute_pkey PRIMARY KEY (id)); CREATE INDEX market_price_us500_fifteen_minute_1 ON public.market_price_us500_every_fifteen_minute USING btree ("time");
CREATE TABLE public.market_price_usdjpy_every_fifteen_minute (	id bigserial NOT NULL, 	high numeric(20, 10) NULL, 	low numeric(20, 10) NULL, 	"close" numeric(20, 10) NULL, 	"open" numeric(20, 10) NULL,	"time" timestamptz NULL, 	CONSTRAINT market_price_usdjpy_fifteen_minute_pkey PRIMARY KEY (id)); CREATE INDEX market_price_usdjpy_fifteen_minute_1 ON public.market_price_usdjpy_every_fifteen_minute USING btree ("time");
CREATE TABLE public.market_price_xagusd_every_fifteen_minute (	id bigserial NOT NULL, 	high numeric(20, 10) NULL, 	low numeric(20, 10) NULL, 	"close" numeric(20, 10) NULL, 	"open" numeric(20, 10) NULL,	"time" timestamptz NULL, 	CONSTRAINT market_price_xagusd_fifteen_minute_pkey PRIMARY KEY (id)); CREATE INDEX market_price_xagusd_fifteen_minute_1 ON public.market_price_xagusd_every_fifteen_minute USING btree ("time");
CREATE TABLE public.market_price_xauusd_every_fifteen_minute (	id bigserial NOT NULL, 	high numeric(20, 10) NULL, 	low numeric(20, 10) NULL, 	"close" numeric(20, 10) NULL, 	"open" numeric(20, 10) NULL,	"time" timestamptz NULL, 	CONSTRAINT market_price_xauusd_fifteen_minute_pkey PRIMARY KEY (id)); CREATE INDEX market_price_xauusd_fifteen_minute_1 ON public.market_price_xauusd_every_fifteen_minute USING btree ("time");
CREATE TABLE public.market_price_xrpusd_every_fifteen_minute (	id bigserial NOT NULL, 	high numeric(20, 10) NULL, 	low numeric(20, 10) NULL, 	"close" numeric(20, 10) NULL, 	"open" numeric(20, 10) NULL,	"time" timestamptz NULL, 	CONSTRAINT market_price_xrpusd_fifteen_minute_pkey PRIMARY KEY (id)); CREATE INDEX market_price_xrpusd_fifteen_minute_1 ON public.market_price_xrpusd_every_fifteen_minute USING btree ("time");
CREATE TABLE public.market_price_zc_every_fifteen_minute (	id bigserial NOT NULL, 	high numeric(20, 10) NULL, 	low numeric(20, 10) NULL, 	"close" numeric(20, 10) NULL, 	"open" numeric(20, 10) NULL,	"time" timestamptz NULL, 	CONSTRAINT market_price_zc_fifteen_minute_pkey PRIMARY KEY (id)); CREATE INDEX market_price_zc_fifteen_minute_1 ON public.market_price_zc_every_fifteen_minute USING btree ("time");
CREATE TABLE public.market_price_zg_every_fifteen_minute (	id bigserial NOT NULL, 	high numeric(20, 10) NULL, 	low numeric(20, 10) NULL, 	"close" numeric(20, 10) NULL, 	"open" numeric(20, 10) NULL,	"time" timestamptz NULL, 	CONSTRAINT market_price_zg_fifteen_minute_pkey PRIMARY KEY (id)); CREATE INDEX market_price_zg_fifteen_minute_1 ON public.market_price_zg_every_fifteen_minute USING btree ("time");
CREATE TABLE public.market_price_zi_every_fifteen_minute (	id bigserial NOT NULL, 	high numeric(20, 10) NULL, 	low numeric(20, 10) NULL, 	"close" numeric(20, 10) NULL, 	"open" numeric(20, 10) NULL,	"time" timestamptz NULL, 	CONSTRAINT market_price_zi_fifteen_minute_pkey PRIMARY KEY (id)); CREATE INDEX market_price_zi_fifteen_minute_1 ON public.market_price_zi_every_fifteen_minute USING btree ("time");
CREATE TABLE public.market_price_zs_every_fifteen_minute (	id bigserial NOT NULL, 	high numeric(20, 10) NULL, 	low numeric(20, 10) NULL, 	"close" numeric(20, 10) NULL, 	"open" numeric(20, 10) NULL,	"time" timestamptz NULL, 	CONSTRAINT market_price_zs_fifteen_minute_pkey PRIMARY KEY (id)); CREATE INDEX market_price_zs_fifteen_minute_1 ON public.market_price_zs_every_fifteen_minute USING btree ("time");


CREATE TABLE public.market_price_audusd_every_thirty_minute (	id bigserial NOT NULL, 	high numeric(20, 10) NULL, 	low numeric(20, 10) NULL, 	"close" numeric(20, 10) NULL, 	"open" numeric(20, 10) NULL,	"time" timestamptz NULL, 	CONSTRAINT market_price_audusd_thirty_minute_pkey PRIMARY KEY (id)); CREATE INDEX market_price_audusd_thirty_minute_1 ON public.market_price_audusd_every_thirty_minute USING btree ("time");
CREATE TABLE public.market_price_axjo_every_thirty_minute (	id bigserial NOT NULL, 	high numeric(20, 10) NULL, 	low numeric(20, 10) NULL, 	"close" numeric(20, 10) NULL, 	"open" numeric(20, 10) NULL,	"time" timestamptz NULL, 	CONSTRAINT market_price_axjo_thirty_minute_pkey PRIMARY KEY (id)); CREATE INDEX market_price_axjo_thirty_minute_1 ON public.market_price_axjo_every_thirty_minute USING btree ("time");
CREATE TABLE public.market_price_btc_every_thirty_minute (	id bigserial NOT NULL, 	high numeric(20, 10) NULL, 	low numeric(20, 10) NULL, 	"close" numeric(20, 10) NULL, 	"open" numeric(20, 10) NULL,	"time" timestamptz NULL, 	CONSTRAINT market_price_btc_thirty_minute_pkey PRIMARY KEY (id)); CREATE INDEX market_price_btc_thirty_minute_1 ON public.market_price_btc_every_thirty_minute USING btree ("time");
CREATE TABLE public.market_price_cadusd_every_thirty_minute (	id bigserial NOT NULL, 	high numeric(20, 10) NULL, 	low numeric(20, 10) NULL, 	"close" numeric(20, 10) NULL, 	"open" numeric(20, 10) NULL,	"time" timestamptz NULL, 	CONSTRAINT market_price_cadusd_thirty_minute_pkey PRIMARY KEY (id)); CREATE INDEX market_price_cadusd_thirty_minute_1 ON public.market_price_cadusd_every_thirty_minute USING btree ("time");
CREATE TABLE public.market_price_cc_every_thirty_minute (	id bigserial NOT NULL, 	high numeric(20, 10) NULL, 	low numeric(20, 10) NULL, 	"close" numeric(20, 10) NULL, 	"open" numeric(20, 10) NULL,	"time" timestamptz NULL, 	CONSTRAINT market_price_cc_thirty_minute_pkey PRIMARY KEY (id)); CREATE INDEX market_price_cc_thirty_minute_1 ON public.market_price_cc_every_thirty_minute USING btree ("time");
CREATE TABLE public.market_price_chfusd_every_thirty_minute (	id bigserial NOT NULL, 	high numeric(20, 10) NULL, 	low numeric(20, 10) NULL, 	"close" numeric(20, 10) NULL, 	"open" numeric(20, 10) NULL,	"time" timestamptz NULL, 	CONSTRAINT market_price_chfusd_thirty_minute_pkey PRIMARY KEY (id)); CREATE INDEX market_price_chfusd_thirty_minute_1 ON public.market_price_chfusd_every_thirty_minute USING btree ("time");
CREATE TABLE public.market_price_ct_every_thirty_minute (	id bigserial NOT NULL, 	high numeric(20, 10) NULL, 	low numeric(20, 10) NULL, 	"close" numeric(20, 10) NULL, 	"open" numeric(20, 10) NULL,	"time" timestamptz NULL, 	CONSTRAINT market_price_ct_thirty_minute_pkey PRIMARY KEY (id)); CREATE INDEX market_price_ct_thirty_minute_1 ON public.market_price_ct_every_thirty_minute USING btree ("time");
CREATE TABLE public.market_price_de30_every_thirty_minute (	id bigserial NOT NULL, 	high numeric(20, 10) NULL, 	low numeric(20, 10) NULL, 	"close" numeric(20, 10) NULL, 	"open" numeric(20, 10) NULL,	"time" timestamptz NULL, 	CONSTRAINT market_price_de30_thirty_minute_pkey PRIMARY KEY (id)); CREATE INDEX market_price_de30_thirty_minute_1 ON public.market_price_de30_every_thirty_minute USING btree ("time");
CREATE TABLE public.market_price_dxy_every_thirty_minute (	id bigserial NOT NULL, 	high numeric(20, 10) NULL, 	low numeric(20, 10) NULL, 	"close" numeric(20, 10) NULL, 	"open" numeric(20, 10) NULL,	"time" timestamptz NULL, 	CONSTRAINT market_price_dxy_thirty_minute_pkey PRIMARY KEY (id)); CREATE INDEX market_price_dxy_thirty_minute_1 ON public.market_price_dxy_every_thirty_minute USING btree ("time");
CREATE TABLE public.market_price_eth_every_thirty_minute (	id bigserial NOT NULL, 	high numeric(20, 10) NULL, 	low numeric(20, 10) NULL, 	"close" numeric(20, 10) NULL, 	"open" numeric(20, 10) NULL,	"time" timestamptz NULL, 	CONSTRAINT market_price_eth_thirty_minute_pkey PRIMARY KEY (id)); CREATE INDEX market_price_eth_thirty_minute_1 ON public.market_price_eth_every_thirty_minute USING btree ("time");
CREATE TABLE public.market_price_eurusd_every_thirty_minute (	id bigserial NOT NULL, 	high numeric(20, 10) NULL, 	low numeric(20, 10) NULL, 	"close" numeric(20, 10) NULL, 	"open" numeric(20, 10) NULL,	"time" timestamptz NULL, 	CONSTRAINT market_price_eurusd_thirty_minute_pkey PRIMARY KEY (id)); CREATE INDEX market_price_eurusd_thirty_minute_1 ON public.market_price_eurusd_every_thirty_minute USING btree ("time");
CREATE TABLE public.market_price_fchi_every_thirty_minute (	id bigserial NOT NULL, 	high numeric(20, 10) NULL, 	low numeric(20, 10) NULL, 	"close" numeric(20, 10) NULL, 	"open" numeric(20, 10) NULL,	"time" timestamptz NULL, 	CONSTRAINT market_price_fchi_thirty_minute_pkey PRIMARY KEY (id)); CREATE INDEX market_price_fchi_thirty_minute_1 ON public.market_price_fchi_every_thirty_minute USING btree ("time");
CREATE TABLE public.market_price_gbpusd_every_thirty_minute (	id bigserial NOT NULL, 	high numeric(20, 10) NULL, 	low numeric(20, 10) NULL, 	"close" numeric(20, 10) NULL, 	"open" numeric(20, 10) NULL,	"time" timestamptz NULL, 	CONSTRAINT market_price_gbpusd_thirty_minute_pkey PRIMARY KEY (id)); CREATE INDEX market_price_gbpusd_thirty_minute_1 ON public.market_price_gbpusd_every_thirty_minute USING btree ("time");
CREATE TABLE public.market_price_hg_every_thirty_minute (	id bigserial NOT NULL, 	high numeric(20, 10) NULL, 	low numeric(20, 10) NULL, 	"close" numeric(20, 10) NULL, 	"open" numeric(20, 10) NULL,	"time" timestamptz NULL, 	CONSTRAINT market_price_hg_thirty_minute_pkey PRIMARY KEY (id)); CREATE INDEX market_price_hg_thirty_minute_1 ON public.market_price_hg_every_thirty_minute USING btree ("time");
CREATE TABLE public.market_price_hk50_every_thirty_minute (	id bigserial NOT NULL, 	high numeric(20, 10) NULL, 	low numeric(20, 10) NULL, 	"close" numeric(20, 10) NULL, 	"open" numeric(20, 10) NULL,	"time" timestamptz NULL, 	CONSTRAINT market_price_hk50_thirty_minute_pkey PRIMARY KEY (id)); CREATE INDEX market_price_hk50_thirty_minute_1 ON public.market_price_hk50_every_thirty_minute USING btree ("time");
CREATE TABLE public.market_price_hsce_every_thirty_minute (	id bigserial NOT NULL, 	high numeric(20, 10) NULL, 	low numeric(20, 10) NULL, 	"close" numeric(20, 10) NULL, 	"open" numeric(20, 10) NULL,	"time" timestamptz NULL, 	CONSTRAINT market_price_hsce_thirty_minute_pkey PRIMARY KEY (id)); CREATE INDEX market_price_hsce_thirty_minute_1 ON public.market_price_hsce_every_thirty_minute USING btree ("time");
CREATE TABLE public.market_price_ixic_every_thirty_minute (	id bigserial NOT NULL, 	high numeric(20, 10) NULL, 	low numeric(20, 10) NULL, 	"close" numeric(20, 10) NULL, 	"open" numeric(20, 10) NULL,	"time" timestamptz NULL, 	CONSTRAINT market_price_ixic_thirty_minute_pkey PRIMARY KEY (id)); CREATE INDEX market_price_ixic_thirty_minute_1 ON public.market_price_ixic_every_thirty_minute USING btree ("time");
CREATE TABLE public.market_price_jp225_every_thirty_minute (	id bigserial NOT NULL, 	high numeric(20, 10) NULL, 	low numeric(20, 10) NULL, 	"close" numeric(20, 10) NULL, 	"open" numeric(20, 10) NULL,	"time" timestamptz NULL, 	CONSTRAINT market_price_jp225_thirty_minute_pkey PRIMARY KEY (id)); CREATE INDEX market_price_jp225_thirty_minute_1 ON public.market_price_jp225_every_thirty_minute USING btree ("time");
CREATE TABLE public.market_price_jpyusd_every_thirty_minute (	id bigserial NOT NULL, 	high numeric(20, 10) NULL, 	low numeric(20, 10) NULL, 	"close" numeric(20, 10) NULL, 	"open" numeric(20, 10) NULL,	"time" timestamptz NULL, 	CONSTRAINT market_price_jpyusd_thirty_minute_pkey PRIMARY KEY (id)); CREATE INDEX market_price_jpyusd_thirty_minute_1 ON public.market_price_jpyusd_every_thirty_minute USING btree ("time");
CREATE TABLE public.market_price_kc_every_thirty_minute (	id bigserial NOT NULL, 	high numeric(20, 10) NULL, 	low numeric(20, 10) NULL, 	"close" numeric(20, 10) NULL, 	"open" numeric(20, 10) NULL,	"time" timestamptz NULL, 	CONSTRAINT market_price_kc_thirty_minute_pkey PRIMARY KEY (id)); CREATE INDEX market_price_kc_thirty_minute_1 ON public.market_price_kc_every_thirty_minute USING btree ("time");
CREATE TABLE public.market_price_ng_every_thirty_minute (	id bigserial NOT NULL, 	high numeric(20, 10) NULL, 	low numeric(20, 10) NULL, 	"close" numeric(20, 10) NULL, 	"open" numeric(20, 10) NULL,	"time" timestamptz NULL, 	CONSTRAINT market_price_ng_thirty_minute_pkey PRIMARY KEY (id)); CREATE INDEX market_price_ng_thirty_minute_1 ON public.market_price_ng_every_thirty_minute USING btree ("time");
CREATE TABLE public.market_price_nzdusd_every_thirty_minute (	id bigserial NOT NULL, 	high numeric(20, 10) NULL, 	low numeric(20, 10) NULL, 	"close" numeric(20, 10) NULL, 	"open" numeric(20, 10) NULL,	"time" timestamptz NULL, 	CONSTRAINT market_price_nzdusd_thirty_minute_pkey PRIMARY KEY (id)); CREATE INDEX market_price_nzdusd_thirty_minute_1 ON public.market_price_nzdusd_every_thirty_minute USING btree ("time");
CREATE TABLE public.market_price_oj_every_thirty_minute (	id bigserial NOT NULL, 	high numeric(20, 10) NULL, 	low numeric(20, 10) NULL, 	"close" numeric(20, 10) NULL, 	"open" numeric(20, 10) NULL,	"time" timestamptz NULL, 	CONSTRAINT market_price_oj_thirty_minute_pkey PRIMARY KEY (id)); CREATE INDEX market_price_oj_thirty_minute_1 ON public.market_price_oj_every_thirty_minute USING btree ("time");
CREATE TABLE public.market_price_pl_every_thirty_minute (	id bigserial NOT NULL, 	high numeric(20, 10) NULL, 	low numeric(20, 10) NULL, 	"close" numeric(20, 10) NULL, 	"open" numeric(20, 10) NULL,	"time" timestamptz NULL, 	CONSTRAINT market_price_pl_thirty_minute_pkey PRIMARY KEY (id)); CREATE INDEX market_price_pl_thirty_minute_1 ON public.market_price_pl_every_thirty_minute USING btree ("time");
CREATE TABLE public.market_price_sb_every_thirty_minute (	id bigserial NOT NULL, 	high numeric(20, 10) NULL, 	low numeric(20, 10) NULL, 	"close" numeric(20, 10) NULL, 	"open" numeric(20, 10) NULL,	"time" timestamptz NULL, 	CONSTRAINT market_price_sb_thirty_minute_pkey PRIMARY KEY (id)); CREATE INDEX market_price_sb_thirty_minute_1 ON public.market_price_sb_every_thirty_minute USING btree ("time");
CREATE TABLE public.market_price_t_every_thirty_minute (	id bigserial NOT NULL, 	high numeric(20, 10) NULL, 	low numeric(20, 10) NULL, 	"close" numeric(20, 10) NULL, 	"open" numeric(20, 10) NULL,	"time" timestamptz NULL, 	CONSTRAINT market_price_t_thirty_minute_pkey PRIMARY KEY (id)); CREATE INDEX market_price_t_thirty_minute_1 ON public.market_price_t_every_thirty_minute USING btree ("time");
CREATE TABLE public.market_price_tmp_every_thirty_minute (	id bigserial NOT NULL, 	high numeric(20, 10) NULL, 	low numeric(20, 10) NULL, 	"close" numeric(20, 10) NULL, 	"open" numeric(20, 10) NULL,	"time" timestamptz NULL, 	CONSTRAINT market_price_tmp_thirty_minute_pkey PRIMARY KEY (id)); CREATE INDEX market_price_tmp_thirty_minute_1 ON public.market_price_tmp_every_thirty_minute USING btree ("time");
CREATE TABLE public.market_price_uk100_every_thirty_minute (	id bigserial NOT NULL, 	high numeric(20, 10) NULL, 	low numeric(20, 10) NULL, 	"close" numeric(20, 10) NULL, 	"open" numeric(20, 10) NULL,	"time" timestamptz NULL, 	CONSTRAINT market_price_uk100_thirty_minute_pkey PRIMARY KEY (id)); CREATE INDEX market_price_uk100_thirty_minute_1 ON public.market_price_uk100_every_thirty_minute USING btree ("time");
CREATE TABLE public.market_price_us500_every_thirty_minute (	id bigserial NOT NULL, 	high numeric(20, 10) NULL, 	low numeric(20, 10) NULL, 	"close" numeric(20, 10) NULL, 	"open" numeric(20, 10) NULL,	"time" timestamptz NULL, 	CONSTRAINT market_price_us500_thirty_minute_pkey PRIMARY KEY (id)); CREATE INDEX market_price_us500_thirty_minute_1 ON public.market_price_us500_every_thirty_minute USING btree ("time");
CREATE TABLE public.market_price_usdjpy_every_thirty_minute (	id bigserial NOT NULL, 	high numeric(20, 10) NULL, 	low numeric(20, 10) NULL, 	"close" numeric(20, 10) NULL, 	"open" numeric(20, 10) NULL,	"time" timestamptz NULL, 	CONSTRAINT market_price_usdjpy_thirty_minute_pkey PRIMARY KEY (id)); CREATE INDEX market_price_usdjpy_thirty_minute_1 ON public.market_price_usdjpy_every_thirty_minute USING btree ("time");
CREATE TABLE public.market_price_xagusd_every_thirty_minute (	id bigserial NOT NULL, 	high numeric(20, 10) NULL, 	low numeric(20, 10) NULL, 	"close" numeric(20, 10) NULL, 	"open" numeric(20, 10) NULL,	"time" timestamptz NULL, 	CONSTRAINT market_price_xagusd_thirty_minute_pkey PRIMARY KEY (id)); CREATE INDEX market_price_xagusd_thirty_minute_1 ON public.market_price_xagusd_every_thirty_minute USING btree ("time");
CREATE TABLE public.market_price_xauusd_every_thirty_minute (	id bigserial NOT NULL, 	high numeric(20, 10) NULL, 	low numeric(20, 10) NULL, 	"close" numeric(20, 10) NULL, 	"open" numeric(20, 10) NULL,	"time" timestamptz NULL, 	CONSTRAINT market_price_xauusd_thirty_minute_pkey PRIMARY KEY (id)); CREATE INDEX market_price_xauusd_thirty_minute_1 ON public.market_price_xauusd_every_thirty_minute USING btree ("time");
CREATE TABLE public.market_price_xrpusd_every_thirty_minute (	id bigserial NOT NULL, 	high numeric(20, 10) NULL, 	low numeric(20, 10) NULL, 	"close" numeric(20, 10) NULL, 	"open" numeric(20, 10) NULL,	"time" timestamptz NULL, 	CONSTRAINT market_price_xrpusd_thirty_minute_pkey PRIMARY KEY (id)); CREATE INDEX market_price_xrpusd_thirty_minute_1 ON public.market_price_xrpusd_every_thirty_minute USING btree ("time");
CREATE TABLE public.market_price_zc_every_thirty_minute (	id bigserial NOT NULL, 	high numeric(20, 10) NULL, 	low numeric(20, 10) NULL, 	"close" numeric(20, 10) NULL, 	"open" numeric(20, 10) NULL,	"time" timestamptz NULL, 	CONSTRAINT market_price_zc_thirty_minute_pkey PRIMARY KEY (id)); CREATE INDEX market_price_zc_thirty_minute_1 ON public.market_price_zc_every_thirty_minute USING btree ("time");
CREATE TABLE public.market_price_zg_every_thirty_minute (	id bigserial NOT NULL, 	high numeric(20, 10) NULL, 	low numeric(20, 10) NULL, 	"close" numeric(20, 10) NULL, 	"open" numeric(20, 10) NULL,	"time" timestamptz NULL, 	CONSTRAINT market_price_zg_thirty_minute_pkey PRIMARY KEY (id)); CREATE INDEX market_price_zg_thirty_minute_1 ON public.market_price_zg_every_thirty_minute USING btree ("time");
CREATE TABLE public.market_price_zi_every_thirty_minute (	id bigserial NOT NULL, 	high numeric(20, 10) NULL, 	low numeric(20, 10) NULL, 	"close" numeric(20, 10) NULL, 	"open" numeric(20, 10) NULL,	"time" timestamptz NULL, 	CONSTRAINT market_price_zi_thirty_minute_pkey PRIMARY KEY (id)); CREATE INDEX market_price_zi_thirty_minute_1 ON public.market_price_zi_every_thirty_minute USING btree ("time");
CREATE TABLE public.market_price_zs_every_thirty_minute (	id bigserial NOT NULL, 	high numeric(20, 10) NULL, 	low numeric(20, 10) NULL, 	"close" numeric(20, 10) NULL, 	"open" numeric(20, 10) NULL,	"time" timestamptz NULL, 	CONSTRAINT market_price_zs_thirty_minute_pkey PRIMARY KEY (id)); CREATE INDEX market_price_zs_thirty_minute_1 ON public.market_price_zs_every_thirty_minute USING btree ("time");
...
from 
 ...
 select DATE_TRUNC('day', time), count(1) from ctrader_market_price_eth_every_minute cmpgefm group by DATE_TRUNC('day', time) order by DATE_TRUNC('day', time) desc
 select DATE_TRUNC('day', time), count(1) from ctrader_market_price_xauchf_every_minute cmpgefm group by DATE_TRUNC('day', time) order by DATE_TRUNC('day', time) desc
 select DATE_TRUNC('day', time), count(1) from ctrader_market_price_xaueur_every_minute cmpgefm group by DATE_TRUNC('day', time) order by DATE_TRUNC('day', time) desc
 select DATE_TRUNC('day', time), count(1) from ctrader_market_price_xauchf_every_fifteen_minute  cmpgefm group by DATE_TRUNC('day', time) order by DATE_TRUNC('day', time) desc
 select DATE_TRUNC('day', time), count(1) from ctrader_market_price_xauchf_hourly  cmpgefm group by DATE_TRUNC('day', time) order by DATE_TRUNC('day', time) desc
